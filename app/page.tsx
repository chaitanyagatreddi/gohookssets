...
].map(([name,body],i)=><article className="workflow-row" key={name}><span className="row-number">0{i+1}</span><h3>{name}</h3><p>{body}</p><ArrowUpRight className="row-arrow" size={21}/></article>)}</div></section>
