...
<section className="section thesis" id="product"><div className="section-label"><span>02 / THE KNOWLEDGE GRAPH</span><span className="tiny-cross">+</span></div><div className="split"><h2>A graph<br/>you can query.</h2><p className="section-copy">Connect entities and relationships. Follow the connections to an answer — with a path you can trace.</p></div><div className="path-visual" aria-label="Subreddit, Thread, Brand, Intent, Collaborate"><div><span className="path-dot"/><small>COMMUNITY</small><strong>Subreddit</strong></div><span className="path-edge">contains <ArrowRight size={16}/></span><div><span className="path-dot"/><small>CONVERSATION</small><strong>Thread</strong></div><span className="path-edge">mentions <ArrowRight size={16}/></span><div><span className="path-dot"/><small>ENTITY</small><strong>Brand</strong></div><span className="path-edge">reveals <ArrowRight size={16}/></span><div><span className="path-dot active"/><small>SIGNAL</small><strong>Intent</strong></div><span className="path-edge collaborate-edge"><ArrowRight size={16}/></span><div className="collaborate-node"><span className="path-dot"/><strong>Collaborate</strong></div></div></section>
<section className="section workflows" id="workflows"><div className="section-label"><span>03 / GRAPH WORKFLOWS</span><span className="tiny-cross">+</span></div><h2>What you do in GoHook.</h2><WorkflowShowcase/></section>
<section className="section how" id="how-it-works"><div className="section-label"><span>04 / HOW IT WORKS</span><span className="tiny-cross">+</span></div><h2>Seed → map → query → act.</h2><div className="steps">{[['Seed','Start with a brand, topic, or community.'],['Map','Connect threads, entities, and intent.'],['Query → act','Ask a question. Trace the answer. Decide what to do next.']].map(([name,body],i)=><article key={name}><span className="step-number">0{i+1}</span><h3>{name}</h3><p>{body}</p></article>)}</div></section>
<section className="section trust" id="trust"><div className="section-label"><span>05 / TRUST & SAFETY</span><span className="tiny-cross">+</span></div><div className="split"><h2>Ban-aware<br/>by design.</h2><div><p className="section-copy">Subreddit rules. Controlled volume. Quality over spray.</p><p className="quiet">Keep the community’s context in every action.</p></div></div></section>
<section className="section audience" id="audience"><div className="section-label"><span>06 / WHO IT’S FOR</span><span className="tiny-cross">+</span></div><div className="split"><h2>From solo<br/>to agency.</h2><p className="section-copy">One knowledge graph for research, listening, and growth.</p></div><div className="audience-line"><span>Hobbyists</span><span>Freelancers</span><span>Startups</span><span>Agencies</span></div></section>
